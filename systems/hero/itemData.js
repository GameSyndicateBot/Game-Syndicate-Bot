...
const ITEMS = Object.freeze({
  ...
  travel_stew:{name:'Походное рагу',type:'consumable',rarity:'common',description:'Еда: ❤️ +10% максимального HP на 30 минут. Экспедиция: +5% успеха.',lore:'Простое блюдо, которое помогает пережить долгий путь.',bonuses:{expedition_success:5,max_hp_percent:10,food_duration:30},consumable:1},
  hunters_meal:{name:'Ужин охотника',type:'consumable',rarity:'rare',description:'Еда: ⚔️ +5 Сила, 🌀 +5 Ловкость, ❤️ +10% максимального HP на 1 час.',lore:'Питательная еда охотников и разведчиков.',bonuses:{strength:5,dexterity:5,max_hp_percent:10,food_duration:60},consumable:1},
  guild_feast:{name:'Гильдейский пирог',type:'consumable',rarity:'epic',description:'Еда: ✨ +5 Мудрость, ❤️ +10% эффективность лечения, 🛡️ +5% магическая защита на 1 час.',lore:'Особый пирог для тех, кто поддерживает отряд.',bonuses:{wisdom:5,healing_power:10,magic_resistance:5,food_duration:60},consumable:1},
