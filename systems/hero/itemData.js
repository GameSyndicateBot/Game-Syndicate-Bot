...
const ITEMS = Object.freeze({
  ...
  healing_potion_supreme:{name:'Зелье полного восстановления',type:'consumable',rarity:'epic',description:'Восстанавливает 140 HP героя.',lore:'Жидкость светится тёплым золотом и затягивает даже тяжёлые раны.',bonuses:{heal:140},consumable:1},
  ...
  war_elixir:{name:'Эликсир боевого транса',type:'consumable',rarity:'epic',description:'Увеличивает урон в следующем бою с мировым боссом на 15%.',lore:'Сердце начинает биться в ритме далёких боевых барабанов.',bonuses:{world_boss_damage:15},consumable:1},
  stone_skin_elixir:{name:'Эликсир каменной кожи',type:'consumable',rarity:'epic',description:'Увеличивает сопротивление в следующем бою с мировым боссом на 15%.',lore:'На несколько мгновений кожа покрывается узором древних рун.',bonuses:{world_boss_resistance:15},consumable:1},
  ...
  travel_stew:{name:'Походное рагу',type:'consumable',rarity:'common',description:'Даёт +5% к успеху следующей экспедиции и снижает риск ранения.',lore:'Горячее блюдо, которое возвращает силы перед дорогой.',bonuses:{expedition_success:5,injury_resistance:10},consumable:1},
  hunters_meal:{name:'Ужин охотника',type:'consumable',rarity:'rare',description:'Даёт +8% к успеху, +10% к редкой добыче и больше опыта в следующей экспедиции.',lore:'Сытное блюдо для тех, кто идёт далеко и надолго.',bonuses:{expedition_success:8,rare_find:10,class_xp_bonus:10},consumable:1},
  guild_feast:{name:'Гильдейский пирог',type:'consumable',rarity:'epic',description:'Усиливает следующую экспедицию или бой с мировым боссом.',lore:'Его делят перед самыми опасными походами.',bonuses:{expedition_success:10,world_boss_damage:8,world_boss_resistance:8},consumable:1},
