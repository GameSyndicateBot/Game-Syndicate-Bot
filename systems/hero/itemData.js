...
const ITEMS = Object.freeze({
  ...
  swift_tonic:{name:'Тоник следопыта',type:'consumable',rarity:'common',description:'Повышает шанс успеха следующей экспедиции.',lore:'Лёгкий настой, от которого дорога кажется короче.',bonuses:{expedition_success:8},consumable:1},
  fortune_elixir:{name:'Эликсир удачи',type:'consumable',rarity:'rare',description:'Повышает успех и шанс редкой добычи в следующей экспедиции.',lore:'Внутри медленно вращается золотая искра.',bonuses:{expedition_success:6,rare_find:12},consumable:1},
