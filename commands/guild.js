...
function itemName(key){return MATERIALS[key]?.name||ITEMS[key]?.name||key;}
function itemIcon(key){return MATERIALS[key]?.icon||ITEMS[key]?.icon||'📦';}
