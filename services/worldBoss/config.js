...
const CLASSES = {
  ...
  archer:{name:'Лучник',role:'dps',cardId:2067,maxHp:110,damage:[24,34],miss:10,skill:{name:'3 удара',cost:40},ultimate:{name:'Дождь стрел',cost:100}},
  mage:{name:'Маг',role:'dps',cardId:2068,maxHp:95,damage:[25,38],miss:8,skill:{name:'Огненный шар',cost:40},ultimate:{name:'Метеор',cost:100}},
  berserker:{name:'Берсерк',role:'support',cardId:2069,maxHp:150,damage:[24,32],miss:12,skill:{name:'Ярость Берсерка',cost:40},ultimate:{name:'Бешеный удар',cost:100}},
  engineer:{name:'Инженер',role:'support',cardId:2070,maxHp:125,damage:[22,30],miss:9,skill:{name:'Турель',cost:40},ultimate:{name:'Голем',cost:100}},
  necromancer:{name:'Некромант',role:'support',cardId:2071,maxHp:115,damage:[23,31],miss:10,skill:{name:'Скелет',cost:40},ultimate:{name:'Армия',cost:100}},
};
...
const BOSSES = [
  ...
  {cardId:2040,name:'Железный Колосс',baseHp:1750,damage:[30,45],miss:12,minions:[2051,2052],summonEvery:3},
  {cardId:2041,name:'Грозовой Тиран',baseHp:1600,damage:[30,44],miss:12,minions:[2053],summonEvery:2},
